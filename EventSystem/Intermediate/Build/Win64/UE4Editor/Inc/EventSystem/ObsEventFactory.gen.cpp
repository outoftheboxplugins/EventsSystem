...
#include "EventSystem/ObsEventFactory.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	EVENTSYSTEM_API UClass* Z_Construct_UClass_UObsEventFactory_NoRegister();
	EVENTSYSTEM_API UClass* Z_Construct_UClass_UObsEventFactory();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UObsEventFactory_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "ObsEventFactory.h" },
		{ "ModuleRelativePath", "ObsEventFactory.h" },
		{ "ObjectInitializerConstructorDeclared", "" },
		{ "ToolTip", "Creats events in the Content browser." },
	};
#endif
	...
	IMPLEMENT_CLASS(UObsEventFactory, 2467934824);
	static FCompiledInDefer Z_CompiledInDefer_UClass_UObsEventFactory(Z_Construct_UClass_UObsEventFactory, &UObsEventFactory::StaticClass, TEXT("/Script/EventSystem"), TEXT("UObsEventFactory"), false, nullptr, nullptr, nullptr);
