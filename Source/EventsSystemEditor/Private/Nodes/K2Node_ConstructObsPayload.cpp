...
{
	return LOCTEXT("ConstructObsPayloadK2Node_MenuCategory", "EventsSystems");
}
...
void UK2Node_ConstructObsPayload::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	CallInvokeNode->FunctionReference.SetExternalMember(GET_FUNCTION_NAME_CHECKED(UEventsSystem, Invoke), UEventsSystem::StaticClass());
